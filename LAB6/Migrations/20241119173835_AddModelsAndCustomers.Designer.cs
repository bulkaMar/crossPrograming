...
namespace LAB6.Migrations
{
    ...
    [Migration("20241119173835_AddModelsAndCustomers")]
    partial class AddModelsAndCustomers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LAB6.Models.MechanicOnService", b =>
                {
                    ...
                    b.Property<int>("ServiceBookingSvcBookingId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ServiceBookingSvcBookingId");
            ...
            modelBuilder.Entity("LAB6.Models.Model", b =>
                {
                    ...
                    b.Property<int?>("ManufacturerCode1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LAB6.Models.Car", b =>
                {
                    ...
                    b.HasOne("LAB6.Models.Model", null)
                        .WithMany("Cars")
                        .HasForeignKey("ModelCode1");
            ...
            modelBuilder.Entity("LAB6.Models.Model", b =>
                {
                    ...
                    b.HasOne("LAB6.Models.Manufacturer", null)
                        .WithMany("Models")
                        .HasForeignKey("ManufacturerCode1");
